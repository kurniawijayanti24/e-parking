...
<head>
  ...
  <!-- end: Css -->
  <link rel="shortcut icon" href="asset/img/logobaru3.jpg">
  ...
  if (isset($_POST['btn_masuk'])) {
    ...
    if ($select_isi >= 10) {
      ...
      if($cek_kode>=1) {
        ...
        $sql = "INSERT INTO tb_daftar_parkir(kode, plat_nomor, jenis, jam_masuk, jam_keluar, status) VALUES('$kode', '$plat_nomor', '$jenis', '$jam_masuk', '$jam_keluar', '1')";
        ...
        <nav class="navbar navbar-default header navbar-fixed-top bg-teal">
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
                ...
                <img src="asset/img/logobaru3.jpg" class="img-circle" alt="logo" style="float: left;margin-top: -10px;" width="45px"/>
                 <b style="float: left;margin-left: 4px;">ParkLink</b>
                </div>
                      ...
                      <div class="col-md-12">
                        <form class="cmxform" method="POST">
                          ...
                          <div class="col-md-5" style="padding-top: 10px">
                            <label><h4>Jenis Kendaraan 123</h4></label>
                          </div>

                          <div class="col-md-5" style="padding:5px 20px 0 25px" name="jenis_kendaraan">
